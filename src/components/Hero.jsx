...
export default function Hero() {
  return (
    <>
      <section className="bg-[#fbf8ef] relative overflow-hidden min-h-screen pb-8 md:pb-40">
        <svg
        ...
        <div className="max-w-[1500px] mx-auto mb-4 md:mb-10 px-5 text-[#1a3659] flex flex-col md:flex-row relative z-10">
          <div className="md:pt-60 pt-24 flex-1">
            <h1
              className="md:text-7xl text-2xl font-extrabold"
              data-aos="fade-up"
            >
              The Strength <br />
              of Curosity
              ...
              <span className="md:text-8xl text-2xl relative">
                Learning.
                <span className="absolute left-0 p-80 max-md:hidden bg-[#306dcf] rounded-full -z-50 opacity-10 animate-float" />
              </span>
            </h1>
            <h3
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-[#0a0a3b] via-[#1a3bb9] to-[#0a0a3b] opacity-0 group-hover:opacity-40 transition-all duration-300 rounded-lg blur-sm" />
            </a>
          </div>

          <div className="relative pt-4 md:pt-44 flex-1 max-md:flex max-md:justify-center">
            <img
              data-aos="fade-up"
              data-aos-duration="500"
              className="rounded-full md:ml-[100px] md:scale-110 max-md:ml-0 max-md:scale-100 max-md:w-[220px] max-md:h-auto"
              src={image.aarya}
              alt="Portrait"
            />
          </div>
